...
def searchPage(Request):
    if(Request.method=="POST"):
        ...
        data= Employee.objects.filter(Q(name__icontains=search)|Q(city__icontains=search)|Q(state__icontains=search)|Q(email__icontains=search)|Q(phone__icontains=search))
        return render(Request,"index.html",{'data':data})
